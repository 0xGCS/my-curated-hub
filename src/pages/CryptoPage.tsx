...
const columns: ColumnConfig[] = [
  ...
  { key: "from", label: "Source", type: "string", width: "min-w-[100px]" },
  ...
  return (
    <Layout>
      <div className="container py-8">
        <div className="mb-8">
          <h1 className="font-serif text-3xl sm:text-4xl font-medium mb-2">Crypto</h1>
          <p className="text-muted-foreground">
            Cryptocurrency analysts, researchers, developers, and influential voices in the space.
          </p>
        </div>
