...
export default function InvestingPage() {
  ...
  // Filter for investing category only
  const investingData = data.filter(
    (row) => row.category?.toLowerCase() === "investing"
  );
  ...
  return (
    <Layout>
      <div className="container py-8">
        <div className="mb-8">
          <h1 className="font-serif text-3xl sm:text-4xl font-medium mb-2">Investing</h1>
          <p className="text-muted-foreground">
            Finance experts, market analysts, traders, and investment research resources.
          </p>
        </div>
